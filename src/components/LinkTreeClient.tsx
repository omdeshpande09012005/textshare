...
export default function LinkTreeClient({ linkTree }: { linkTree: LinkTreeData }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-900 via-purple-900/20 to-surface-900 dark:from-surface-900 dark:via-purple-900/20 dark:to-surface-900 light:from-surface-cream light:via-brand-50 light:to-surface-cream text-white dark:text-white light:text-text-dark relative overflow-hidden">
      {/* Animated Background */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-mesh-gradient animate-aurora opacity-30 dark:opacity-30 light:opacity-10" />
      ...
      <div className="relative z-10 mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="text-center mb-8 animate-fade-up">
          {/* Avatar Placeholder */}
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-brand-500 to-accent mb-4 text-4xl font-bold shadow-glow-md text-white">
          ...
          {/* View Count */}
          <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 dark:bg-white/5 light:bg-white border border-white/10 dark:border-white/10 light:border-brand-300 backdrop-blur-md">
        ...
        <div className="space-y-4 mb-8">
          {linkTree.links.map((link, index) => (
            <button
              ...
              className="group w-full relative rounded-2xl bg-gradient-to-br from-white/10 to-white/5 dark:from-white/10 dark:to-white/5 light:from-white light:to-brand-50 border border-white/20 dark:border-white/20 light:border-brand-200 hover:border-white/30 dark:hover:border-white/30 light:hover:border-brand-400 p-6 backdrop-blur-xl transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-1 active:scale-95 overflow-hidden animate-fade-up shadow-lg light:shadow-brand-100"
        ...
        {/* Share Section */}
        <div className="relative rounded-2xl bg-gradient-to-br from-white/5 to-white/10 dark:from-white/5 dark:to-white/10 light:from-white light:to-brand-50 border border-white/10 dark:border-white/10 light:border-brand-200 p-6 backdrop-blur-xl overflow-hidden shadow-lg light:shadow-brand-100">
        ...
        <div className="mt-8 text-center">
          <a
            href="/"
            className="inline-flex items-center gap-2 text-sm text-white/40 dark:text-white/40 light:text-text-dark/60 hover:text-white/60 dark:hover:text-white/60 light:hover:text-brand-600 transition-colors"
          >
            <span>Made with</span>
            <span className="text-red-400 dark:text-red-400 light:text-red-500">✨</span>
            <span className="bg-gradient-to-r from-brand-400 to-accent dark:from-brand-400 dark:to-accent light:from-brand-600 light:to-brand-500 bg-clip-text text-transparent font-medium">
              TextShare
            </span>
          </a>
        </div>
